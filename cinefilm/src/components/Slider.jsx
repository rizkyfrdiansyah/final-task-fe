...
const Slider = () => {
  ...
  return (
    <div className="slider w-full mt-16 md:mt-10">
      <div>
        <Carousel showArrows={false} showStatus={false} showThumbs={false} infiniteLoop={true} autoPlay={true} interval={3000} className="md:mx-auto">
